//! Linux mechanics for cache materialization: replacement, link
...
/// Exchange the two trees in place (renameat2 `RENAME_EXCHANGE`) when
...
/// Linux keeps no per-file change journal this crate can read.
